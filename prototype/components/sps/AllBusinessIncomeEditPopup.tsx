...
export default function AllBusinessIncomeEditPopup({ data, onClose, onSaved, onDeleted }: Props) {
  const [payYear, setPayYear] = useState<string>(String(data.paymentYear));
  const [payMonth, setPayMonth] = useState<string>(String(data.paymentMonth));
  ...
  const initialRef = useRef({
    payYear: String(data.paymentYear),
    payMonth: String(data.paymentMonth),
