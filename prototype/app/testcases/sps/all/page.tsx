...
const tabs = [
  ...
  { id: "sps-all-add", label: "전체 사업소득 추가 팝업", policy: spsAllAddPolicy },
  { id: "sps-all-edit", label: "전체 사업소득 수정 팝업", policy: spsAllEditPolicy },
...
export default function TestCasesSpsAllPage() {
